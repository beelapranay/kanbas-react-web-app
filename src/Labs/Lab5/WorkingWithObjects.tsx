...
export default function WorkingWithObjects() {
    ...
    const [module, setModule] = useState({
        id: "A123",
        name: "Module-1",
        description: "This is the module-1 of this lesson.",
        course: "Web Dev"
    });
    ...
    return (
        <div id="wd-working-with-objects">
            ...
            <input className="w-75 form-control" id="wd-module-name"
            ...
            <input className="w-75 form-control" id="wd-module-description"
